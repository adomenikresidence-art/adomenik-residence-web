...
export const metadata: Metadata = {
  ...
  description:
    "Contact our sales team for luxury apartments in Zakaki, Limassol. Schedule viewings, investment inquiries, Cyprus relocation assistance. +357 99 405 417. Open Mon-Sat.",
  keywords: [
