...
export const metadata: Metadata = {
  title: "Rooftop Suite | Luxury Zakaki Apartments Limassol",
  description: "Spacious 3-bedroom rooftop suite with the largest private roof garden and panoramic views in Zakaki, Limassol.",
  openGraph: {
    title: "Rooftop Suite | Zakaki Limassol",
    description: "Experience the best of Mediterranean living with this corner residence featuring a large roof garden and spectacular views.",
    url: "https://a-domenik-residence.com/apartments/grand-corner-residence",
    images: [
      {
        url: "/apartment-frontview.jpg",
        width: 1200,
        height: 630,
        alt: "Rooftop Suite in Zakaki, Limassol"
      }
    ]
  },
  alternates: {
    canonical: "https://a-domenik-residence.com/apartments/grand-corner-residence"
  }
}
...
const apartment = {
  ...
  features: [
    ...
    "Private 53.3m² roof garden with WC, bathroom, and BBQ area",
